...
void Canvas::fillTriangle(Vec3d* verts, Vec3d *real_verts, Vec3d* norms, light_source *light, Vec3d &camera, LightKoefs* koefs)
{
    info.paintWidget->fillTriangle(verts, real_verts, norms, light, camera, koefs);
}
